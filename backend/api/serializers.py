...
from .models import (
    ...
    OfertaProduto, Vendedor, AvaliacaoLoja, Cliente, Endereco, Sugestao, Administrador
)
...
class MeusProdutosSerializer(serializers.ModelSerializer):
    ...
    def get_url_imagem(self, obj):
        ...
        default_image_url = request.build_absolute_uri(settings.MEDIA_URL + 'ia.png') # type: ignore
